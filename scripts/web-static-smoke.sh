...
need_pattern "web/index.html" "읽기 전용 점검"
need_pattern "web/index.html" "설치 안내서"
...
need_pattern "web/index.html" "id=\"install-disclaimer-accepted\""
need_pattern "web/index.html" "무료 오픈소스 사용 동의"
...
need_pattern "web/app.js" "disclaimer_accepted"
need_pattern "web/app.js" "installDisclaimerAccepted"
...
need_pattern "web/app.js" "runG7Finalize"
need_pattern "web/app.js" "/api/finalize"
...
need_pattern "web/input.css" "padding-top: 1.25rem"
need_pattern "web/input.css" "padding-bottom: 1rem"
need_pattern "web/input.css" 'html\[data-theme="light"\],'
reject_pattern "web/input.css" "sm:mt-5" "desktop app shell spacing must use body padding to prevent a collapsed white gutter"
...
need_pattern "web/input.css" ".install-disclaimer"
...
need_web_setup_pattern "/setup/guide"
need_web_setup_pattern "/api/artifacts/setup-guide"
need_web_setup_pattern "/api/finalize"
need_web_setup_pattern "validate_database_request"
need_web_setup_pattern "validate_disclaimer_acceptance"
...
need_pattern "scripts/quality-gate.sh" "G7_WEB_E2E"
need_pattern "scripts/web-ui-e2e.spec.mjs" "wizard routes render concise result"
