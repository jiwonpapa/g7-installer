...
> 현재 `v0.2.2`는 설치기 바이너리 설치, 웹 컨트롤러 기반 설정, 서버 사전 점검, 설치 계획 생성, 설치 준비 파일 생성, 오류 힌트/상세 리포팅까지 검증합니다.
...
```bash
curl -fsSL https://raw.githubusercontent.com/jiwonpapa/g7-installer/main/scripts/bootstrap.sh | sudo env G7_INSTALL_VERSION=v0.2.2 bash
```
...
```text
https://github.com/jiwonpapa/g7-installer/releases/tag/v0.2.2
```
