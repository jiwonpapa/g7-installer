...
> 현재 `v0.1.6`는 설치기 바이너리 설치, 서버 사전 점검, 풀스크린 TUI 선택, 설치 준비 파일 생성까지 검증합니다.
...
```bash
curl -fsSL https://raw.githubusercontent.com/jiwonpapa/g7-installer/main/scripts/bootstrap.sh | sudo env G7_INSTALL_VERSION=v0.1.6 bash
```
...
```text
https://github.com/jiwonpapa/g7-installer/releases/tag/v0.1.6
```
